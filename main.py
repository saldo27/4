...
class CalendarViewScreen(Screen):
    ...
    def export_summary_pdf(self, month_stats):
        ...
        try:
            ...
            custom_shift_list = ParagraphStyle(
                name='CustomShiftList',
            ...
            date_paragraph = Paragraph(f"Generated on: {current_date}", styles['Normal'])
            elements.append(date_paragraph)
            elements.append(Spacer(1, 6))
        
            user_paragraph = Paragraph(f"Generated by: {app.current_user}", styles['Normal'])
            ...
            post_title = Paragraph("Post Distribution", styles['Heading2'])
            ...
            for worker_id, stats in sorted(month_stats['workers'].items()):
                # Worker header
                worker_header = Paragraph(f"Worker {worker_id}", custom_heading3)
            ...
            # Show error popup for missing ReportLab
            popup = Popup(
                title='Error',
